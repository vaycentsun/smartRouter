...
describe('AddModelModal', () => {
  ...
  it('renders form fields when open', () => {
    ...
    expect(screen.getByPlaceholderText('LiteLLM 模型')).toBeInTheDocument()
  ...
  it('calls onSubmit with parsed data when form is valid', () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('名称'), { target: { value: 'gpt-4' } })
    fireEvent.change(screen.getByPlaceholderText('LiteLLM 模型'), { target: { value: 'openai/gpt-4' } })
